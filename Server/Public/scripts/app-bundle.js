define('app',['exports', 'aurelia-framework', 'aurelia-auth'], function (exports, _aureliaFramework, _aureliaAuth) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaAuth.FetchConfig), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.title = 'Chirps';
      config.map([{ route: ['', 'home'], moduleId: './modules/home', name: 'Home' }, { route: 'list', moduleId: './modules/list', name: 'Wall', auth: true }]);
    };
...
define('modules/list',['exports', 'aurelia-framework', 'aurelia-router', '../resources/data/todos'], function (exports, _aureliaFramework, _aureliaRouter, _todos) {
	'use strict';
	...
	var List = exports.List = (_dec = (0, _aureliaFramework.inject)(_todos.ToDos, _aureliaRouter.Router), _dec(_class = function () {
		function List(todos, router) {
...
define('text!resources/css/styles.css', ['module'], function(module) { module.exports = ".right-margin\r\n{\r\n    margin-right: 10px; \r\n   }"; });
